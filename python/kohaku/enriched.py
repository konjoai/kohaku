...
The metadata primitives (``MemoryMetadata``, ``EnrichedRetrievalResult``, the
trust table, and the datetime/tag helpers) live in :mod:`kohaku.enriched_meta`
